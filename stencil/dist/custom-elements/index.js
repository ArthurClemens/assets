 ...
 */
function factory (options) {/* eslint-disable */
 ...
 */
const injectStyles = (componentId, strings, props = {}, funcs) => {
...
const createElement = Tag => (strings, ...values) => {
  return (props, children) => {
    //STEP: generate a unique component ID
    counter++;
    const componentId = 'sc-' + generateAlphabeticName(murmurhash('sc' + counter));
...
const Themed = styled.div `
  @import url('https://use.typekit.net/jxr8ysw.css');
`;

const myComponentCss = ":host{display:block;font-family:\"sofia-pro-soft\", sans-serif;}.wrapper{color:#333;border-radius:5px;padding:15px;border:1px solid #ddd}h2{font-size:24px;margin:10px 0 0 0;font-weight:500}.logo{width:80px}";
...
const MyComponent = class extends HTMLElement {
  ...
  render() {
    return h(Themed, null, h("div", { class: "wrapper" }, h("img", { class: "logo", src: "https://apps.duxxie.nl/images/general/logo.svg" }), h("h2", null, "Checklist knie")));
  }
  static get style() { return myComponentCss; }
};

const MyComponent$1 = /*@__PURE__*/proxyCustomElement(MyComponent, [1,"my-component",{"first":[1],"last":[1]}]);
