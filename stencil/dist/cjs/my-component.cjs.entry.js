...
const createElement = Tag => (strings, ...values) => {
  return (props, children) => {
    ...
    return index.h(Tag, {class: componentId, ref: props && props.ref}, children);
  };
};
...
const MyComponent = class {
  ...
  render() {
    return index.h(Themed, null, index.h("div", { class: "wrapper" }, index.h("img", { class: "logo", src: "https://apps.duxxie.nl/images/general/logo.svg" }), index.h("h2", null, "Checklist knie")));
  }
};
